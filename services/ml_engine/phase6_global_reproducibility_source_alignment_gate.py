...
def run_phase6_global_reproducibility_source_alignment_gate() -> dict[str, Any]:
    ...
    gate_report = {
        ...
        "official_artifacts_used": [str(PHASE4_REPORT), str(PHASE4_SNAPSHOT)],
        ...
        "next_recommended_step": (
            "Correct Phase 4-R4 source-doc alignment and provide official phase4 artifacts or an isolated clean "
            "regeneration workspace before any readiness gate."
        ),
    }
    gate_manifest = {
        "gate_slug": GATE_SLUG,
        ...
        "commands_executed": [
            ...
            ".\\.venv\\Scripts\\python.exe -m pytest tests/unit/test_phase5_cross_sectional_operational_fragility_audit_and_bounded_correction.py tests/unit/test_phase5_cross_sectional_recent_regime_policy_falsification.py -q",
            ".\\.venv\\Scripts\\python.exe services\\ml_engine\\phase5_cross_sectional_sovereign_closure_bundle_restore_and_revalidate.py",
        ...
        "notes": [
            ...
            "Clean regeneration remains inconclusive because this run is not a clean clone or equivalent proof.",
        ],
    }
    section_bodies = {
        "Resumo executivo": "\n".join(
